package com.epam.rd.java.basic.repairagency.web.command.impl.master;
...
@ProcessUrlPatterns("/master/home")
@ProcessMethods(Method.GET)
public class HomeForMasterGetCommand extends GetCommand {

    private static final Logger log = LogManager.getLogger(HomeForMasterGetCommand.class);
