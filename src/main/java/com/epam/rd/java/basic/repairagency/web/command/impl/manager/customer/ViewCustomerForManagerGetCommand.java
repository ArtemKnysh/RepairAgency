package com.epam.rd.java.basic.repairagency.web.command.impl.manager.customer;
...
@ProcessUrlPatterns("/manager/customer/view")
@ProcessMethods(Method.GET)
public class ViewCustomerForManagerGetCommand extends GetCommand {

    private static final Logger log = LogManager.getLogger(ViewCustomerForManagerGetCommand.class);
    ...
    protected void processRequest(HttpServletRequest request) throws DBException, NotFoundException {
        ...
        List<RepairRequest> customerRepairRequests = repairRequestService.findAllByCustomerId(customerId);
