...
@ProcessUrlPatterns("/manager/feedback/hide")
@ProcessMethods(Method.POST)
public class HideFeedbackForManagerPostCommand extends PostCommandWithRedirectionToReferer {

    private static final Logger log = LogManager.getLogger(HideFeedbackForManagerPostCommand.class);
    ...
    protected Optional<String> getSuccessMessage(HttpServletRequest request) {
        return Optional.of("Feedback was successfully hidden");
    }

    @Override
    protected Optional<String> getErrorMessage(HttpServletRequest request) {
        return Optional.of("Can't hide feedback");
    }
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws DBException, NotFoundException {
        ...
        feedbackService.hide(feedbackId);
    }
